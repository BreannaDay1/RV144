...
```
  ...
  The p-value of .04 means the probability of getting a result like that just obtained if the null hypothesis is true then the chance of getting this is aproximately 4%. This is normally considered significant.
